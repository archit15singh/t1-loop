...
One pass of the T1 loop. Object came in as `anthropic autonomous vulnerability patcher`.
...
**T1 genera.** Closed-loop CRS · Skill pipeline on a coding agent · Whitebox AppSec hunter. Everything else is Tier 2.
...
The procedure of this pass, with topic nouns stripped, is the T1 loop in `LOOP.md`.
